...
const Footer = () => {
    return (
        <footer className="bg-[#050505] text-white pt-20 border-t border-white/5 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 mb-24">
                <div className="text-center mb-12">
                    ...
                    <p className="text-pink-500 font-medium">Easy yet effective!</p>
                </div>

                <div className="grid md:grid-cols-3 gap-8">
                    {/* Option 1: WAV */}
                    <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl overflow-hidden hover:-translate-y-2 transition-transform duration-300">
                    ...
                    {/* Option 2: WAV + STEMS */}
                    <div className="bg-[#0a0a0a] border border-white/5 rounded-2xl overflow-hidden relative hover:-translate-y-2 transition-transform duration-300 transform scale-105 shadow-2xl shadow-purple-900/20 z-10">
                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8 text-center relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-12">
                        <div className="relative w-64 h-[500px] border-4 border-[#222] rounded-[3rem] bg-black overflow-hidden shadow-2xl rotate-[-5deg] hover:rotate-0 transition-all duration-500">
                            ...
                            <div className="w-full h-full bg-indigo-900/20 pt-12 px-4">
                                <div className="w-full h-32 bg-indigo-600 rounded-xl mb-4 animate-pulse opacity-50"></div>
                        ...
                        <div className="relative w-64 h-[500px] border-4 border-[#222] rounded-[3rem] bg-black overflow-hidden shadow-2xl translate-y-12 rotate-[5deg] hover:rotate-0 transition-all duration-500">
                            {/* Phone screen simulation */}
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-6 bg-[#222] rounded-b-xl z-20"></div>
                            <div className="w-full h-full bg-purple-900/20 pt-12 px-4">
                                <div className="w-full h-48 bg-purple-600 rounded-xl mb-4 animate-pulse opacity-50"></div>
                                <div className="w-2/3 h-4 bg-white/20 rounded mb-2"></div>
                                <div className="w-1/2 h-4 bg-white/20 rounded mb-8"></div>
                                <div className="w-full h-12 bg-indigo-500 rounded-full flex items-center justify-center text-sm font-bold">Play Beat</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-24 flex flex-col md:flex-row items-center gap-16">
                <div className="flex-1">
                    <h2 className="text-4xl md:text-5xl font-black mb-4 leading-tight">
                        ...
                        MOST IMPORTANTLY <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">MONETIZATION</span>
                    </h2>
                    <p className="text-xl text-white/60 mb-8">Get paid directly to your bank account.</p>
                    <button className="bg-transparent border border-purple-500 hover:bg-purple-500/10 text-purple-400 font-medium px-8 py-4 rounded-xl transition-all flex items-center gap-3">
                        <Upload size={20} /> Start Selling Now
                    </button>
                </div>
                <div className="flex-1 relative">
                    {/* Abstract Dashboard Graphic */}
                    <div className="bg-[#151515] border border-white/5 rounded-xl p-6 shadow-2xl w-full max-w-lg mx-auto transform hover:scale-105 transition-transform duration-500">
            ...
            {/* SECTION 4: Links */}
            <div className="bg-[#020202] pt-20 pb-12 px-4 md:px-8 border-t border-white/5">
                <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        <div className="bg-white/5 border border-white/10 rounded-lg p-1 flex items-center mb-8">
                            ...
                            <div className="bg-indigo-600 px-3 py-1.5 rounded text-xs font-medium cursor-pointer">General</div>
                        </div>
